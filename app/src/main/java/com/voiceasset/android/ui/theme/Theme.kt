...
private val LightColors =
    lightColorScheme(
        ...
        surfaceDim = Color(0xFFD5DEDB),
        surfaceBright = Color(0xFFF5F8F7),
        surfaceContainerLowest = Color(0xFFFFFFFF),
        surfaceContainerLow = Color(0xFFEEF3F1),
        surfaceContainer = Color(0xFFE7EEEB),
